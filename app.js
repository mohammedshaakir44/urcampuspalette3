...
// FIX: Added 'forest' accent for Campus Academic Pack
const accentMap = {
  ...
  forest:  { bg: 'bg-forest',  text: 'text-forest',  badge: 'bg-forest text-beige' }
};

function renderProducts() {
  const grid = document.getElementById('product-grid');
  grid.innerHTML = products.map((p, i) => {
    const a = accentMap[p.accent] || accentMap.maroon;
    return `
